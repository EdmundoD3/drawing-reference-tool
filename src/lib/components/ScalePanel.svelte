<script lang="ts">
  import { otherDimensionLabel, setScaleDim, setScaleUnit, setScaleValue } from '../state/scale.svelte';
...
<section class="panel">
  ...
  <div class="field">
    ...
    <select id="scaleDim" value={toolState.scale.scaleDim} onchange={onDim}>
